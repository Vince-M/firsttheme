...
export const watch = () => {
  ...
  gulp.watch('src/assetss/js/**/*.js', gulp.series(scripts, reload));
...
// npm run build to run gulp build --prod
// npm run start to run gulp watch tasks
// npm run bundle to run bundle with --prod
// gulp dev
// gulp build
// gulp scripts
// gulp compress to zip file